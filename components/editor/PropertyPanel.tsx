...
export function PropertyPanel() {
  ...
  const handlePropertyChange = (key: string, value: any) => {
    ...
    if (typeof value === 'string' && !isNaN(Number(value)) && (key === 'columns')) {
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-medium text-gray-700">
                    {field.label} ({selectedComponent.props[field.key]?.length || 0})
                  </label>
                  <Button
                    size="sm"
                    variant="outline"
                ...
                <div className="space-y-3">
                  {(selectedComponent.props[field.key] || []).map((item: any, index: number) => (
                    <div
                      key={index}
                        ...
                        <div key={itemField.key}>
                          ...
                          {itemField.type === 'text' && (
                            <input
                              ...
                              onChange={(e) =>
                                handleArrayItemChange(field.key, index, itemField.key, e.target.value)
                              }
